...
<div class="grid h-full" style="grid-template-rows: 1fr env(keyboard-inset-height, 0px);">
  <div class="flex flex-col items-center font-bold bg-lime-300">
    <h1 class="my-4 text-2xl ">Welcome to FDC</h1>
    <div class="text-red-500 ">version 0.2.1</div> 
    <input class="px-2 py-1 my-6 font-medium" placeholder="zabkeksz" type="text">
    <div class="h-full px-4 py-2 bg-orange-300">
